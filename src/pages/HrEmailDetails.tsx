        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sm:mb-8">
              <h1 className="text-2xl sm:text-3xl font-normal text-[#0B4F6C]">HR Contact Information</h1>
              <button
                onClick={handleBack}
            ...
            <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 mb-6 sm:mb-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-b from-[#3a6a88] to-[#4db3b3] rounded-full flex items-center justify-center">
                <span className="text-white text-xl sm:text-2xl font-normal">{getCompanyInitial(companyName)}</span>
              </div>
              <div className="text-center sm:text-left">
                <h2 className="text-xl sm:text-2xl font-normal text-gray-800">{companyName}</h2>
